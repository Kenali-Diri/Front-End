        ...
        <>
            ...
            <Section className="items-center sm:min-h-dvh 2xl:min-h-fit 2xl:max-h-fit py-36 lg:py-16 2xl:py-24 bg-soft-cream">
                <div className="col-span-12 sm:col-span-7 flex justify-center flex-col text-dark-slate">
                    <h1 className="text-5xl lg:text-7xl font-extrabold bg-gradient-to-r from-blue to-pink w-fit bg-clip-text text-transparent" data-aos='fade'>
                        <p>Kenali diri,</p>
                        <p>kenali kamu.</p>
                    </h1>
                    <p className="mt-6 text-sm lg:text-base leading-relaxed" data-aos='fade' data-aos-delay='150'>
            ...
            <Section className="text-soft-cream bg-dark-slate">
                ...
                <div className="flex flex-col justify-center col-span-12 md:col-span-6 lg:col-span-7 py-16">
                    <h2 className="font-bold text-4xl lg:text-5xl" data-aos='fade'>
                        <p>Hmm...,</p>
                        <p>Kenali.Diri??</p>
                    </h2>
                    <p className="leading-relaxed mt-8 text-sm lg:text-base" data-aos='fade'>
            ...
            <Section className="bg-soft-cream text-dark-slate py-20 lg:py-32">
                <h2 className="col-span-12 text-center text-blue text-4xl lg:text-5xl font-bold" data-aos='fade'>
                    Kenapa Kenali.Diri?
                </h2>
                <p className="col-span-12 text-center mt-8 mb-12 text-sm lg:text-base leading-relaxed" data-aos='fade'>
                ...
                <div className='grid grid-cols-12 col-span-12 gap-4'>
                    <div className="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col bg-white rounded-md shadow-md p-6" data-aos='fade-up' data-aos-anchor-placement='bottom-bottom'>
                        <div className="p-4 rounded-full bg-pink/30 w-fit">
                            <Article className="fill-pink" size='size-6 lg:size-8' />
                        </div>
                    ...
                    <div className="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col bg-white rounded-md shadow-md p-6" data-aos='fade-up' data-aos-anchor-placement='bottom-bottom' data-aos-delay='200'>
                        <div className="p-4 rounded-full bg-teal-500/30 w-fit">
                            <Game className="fill-teal-500" size='size-6 lg:size-8' />
                        </div>
                    ...
                    <div className="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col bg-white rounded-md shadow-md p-6" data-aos='fade-up' data-aos-anchor-placement='bottom-bottom' data-aos-delay='400'>
                        <div className="p-4 rounded-full bg-dark-slate/30 w-fit">
                            <Roadmap className="fill-dark-slate p-0.5" size='size-6 lg:size-8' />
                        </div>
                    ...
                    <div className="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col bg-white rounded-md shadow-md p-6" data-aos='fade-up' data-aos-anchor-placement='bottom-bottom' data-aos-delay='600'>
                        <div className="p-4 rounded-full bg-amber-400/30 w-fit">
                            <Medal className="fill-amber-400" size='size-6 lg:size-8' />
                        </div>
            ...
            <Section className="bg-soft-cream relative overflow-hidden">
                <div className="col-span-12 flex justify-end items-end relative z-20 mt-16 pb-8">
                    ...
                    <Image src="/assets/painter.png" width={463} height={463} className="size-[100px] sm:size-[160px] md:size-[220px] lg:size-[360px] absolute left-0 bottom-8 z-20 drop-shadow-lg" alt="Painter image" data-aos='fade-up' data-aos-anchor-placement='center-bottom'/>

                    <div className="flex flex-col lg:gap-1" data-aos='fade-left' data-aos-anchor-placement='top-bottom'>
                ...
                <Image src="/assets/wave.png" width={4320} height={1389} className="absolute w-full h-full top-0 left-0 z-0" alt="Wave image" data-aos='fade' data-aos-anchor-placement='top-bottom'/>
            </Section>
            <Footer />
        </>
    );
