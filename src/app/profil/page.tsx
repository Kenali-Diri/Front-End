            ...
            <Section className="bg-soft-cream py-20 overflow-hidden relative">
                <div className="col-span-12 ">
                    <div className=" grid grid-cols-12 gap-6">
                        <div className="col-span-12">
                            <h2 className="text-4xl sm:text-5xl  md:text-6xl font-bold bg-gradient-to-tr from-[#435BC0] to-[#F6666F] bg-clip-text text-transparent h-16">
                                Pengaturan Akun
                            </h2>
                        </div>
                            ...
                            <div className="grid grid-rows-1 md:grid-rows-0 grid-cols-12 gap-6">
                                ...
                                <div className="col-span-12 md:col-span-9 flex flex-col gap-6">
                                        ...
                                        <div className="flex">
                                            <div className="flex items-center justify-center gap-4">
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <button
                                                        className="bg-blue p-1 text-white rounded-md"
                                                        onClick={() =>
                                                            setEdit(!edit)
                                                        }
                                                    >
                                    ...
                                    <div className="grid grid-cols-12">
                                        <div className="col-span-2 bg-pink p-2 hidden md:flex justify-center items-center rounded-md ">
                                ...
                                <div className="col-span-12 md:col-span-3 flex flex-col gap-6">
                                    <div className="bg-white px-4 py-8 flex flex-col justify-center items-center rounded-md relative">
                                        <h2 className="text-4xl md:text-lg lg:text-4xl text-center text-dark-slate font-bold">
                                            Total Point
                                        </h2>
                                        <h1 className="text-8xl md:text-6xl lg:text-8xl text-blue font-bold">
                                            150
                                        </h1>
                                        <Image
                                            ...
                                            height={100}
                                            alt="mahkota"
                                            className="hidden md:inline absolute right-[10px] top-[-5px] transform translate-x-[50%] translate-y-[-50%]"
                                        />
                                    </div>

                                    <div className="bg-white px-6 py-8 rounded-md flex flex-col gap-8">
                                        <div>
                                            <h2 className="text-xl lg:text-3xl text-dark-slate font-bold">
                                                Ganti Password
                                            </h2>
                                            <p className="hidden lg:block lg:text-sm text-medium-slate">
                                    ...
                                    <div className="grid grid-cols-12">
                                        <div className="col-span-12 bg-pink p-2  flex justify-center items-center rounded-md md:hidden">
                                            <button className="text-white text-center">
                                                Keluar
                                            </button>
                                        </div>
